...
summarydata <- sports %>% select("Percent Communication Major" = pcip09, "Total Enrollment" = ugds, "Percent Male" = ugds_men, "Percent White" = ugds_white, "Average Cost of Attendance" = costt4_a, "Average Age at Enrollment" = age_entry, Region, Sport, "Win Percentage" = Pct, "Multi-Year APR" = Multi.Year.APR, "Year" = Start.Year)

stargazer(summarydata, type = "html",summary.stat = c("mean","sd", "min", "p25", "median", "p75", "max"), title = "Table 2: Summary Statistics")
