...
- ${\beta}_{6} = -3.744 =$ the estimated decrease in win percentage for schools that are in the states of Connecticut, Maine, Massachusetts, New Hampshire, Rhode Island, and Vermont compared to U.S. service schools. The low T-Statistic demonstrates that this is statistically insignificant.

- ${\beta}_{7} = -3.618 =$ the estimated decrease in win percentage for schools that are in the states of Delaware, District of Columbia, Maryland, New Jersey, New York, and Pennsylvania compared to U.S. service schools. The low T-Statistic demonstrates that this is statistically insignificant.

- ${\beta}_{8} = -3.528 =$ the estimated decrease in win percentage for schools that are in the states of Illinois, Indiana, Michigan, Ohio, and Wisconsin compared to U.S. service schools. The low T-Statistic demonstrates that this is statistically insignificant.

- ${\beta}_{9} = -0.444 =$ the estimated decrease in win percentage for schools that are in the states of Iowa, Kansas, Minnesota, Missouri, Nevada, North Dakota, and South Dakota compared to U.S. service schools. The low T-Statistic demonstrates that this is statistically insignificant.

- ${\beta}_{10} = 0.560 =$ the estimated decrease in win percentage for schools that are in the states of Alabama, Arkansas, Florida, Georgia, Kentucky, Louisiana, Mississippi, North Carolina, South Carolina, Tennessee, Virginia, and West Virginia compared to U.S. service schools. The low T-Statistic demonstrates that this is statistically insignificant.

- ${\beta}_{11} = 1.978 =$ the estimated decrease in win percentage for schools that are in the states of Arizona, New Mexico, Oklahoma, and Texas compared to U.S. service schools. The low T-Statistic demonstrates that this is statistically insignificant.

- ${\beta}_{12} = -1.894 =$ the estimated decrease in win percentage for schools that are in the states of Colorado, Idaho, Montana, Utah, and Wyoming compared to U.S. service schools. The low T-Statistic demonstrates that this is statistically insignificant.

- ${\beta}_{13} = -1.626 =$ the estimated decrease in win percentage for schools that are in the states of Alaska, California, Hawaii, Nevada, Oregon, and Washington compared to U.S. service schools. The low T-Statistic demonstrates that this is statistically insignificant.
