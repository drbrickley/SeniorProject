...
\begin{equation*}
\textrm{Pseudo }R^2_{L3_s} = \frac{\hat{\sigma}^{2}(\textrm{Model 6})-\hat{\sigma}^{2}(\textrm{Model 6.a})}{\hat{\sigma}^{2}(\textrm{Model 6})} = \frac{41.21-24.95}{41.21} = 0.3946
\end{equation*}

\begin{equation*}
\textrm{Pseudo }R^2_{L3_s} = \frac{\hat{\sigma}^{2}(\textrm{Model 6.a})-\hat{\sigma}^{2}(\textrm{Model 6.b})}{\hat{\sigma}^{2}(\textrm{Model 6.a})} = \frac{24.95-21.10}{24.95} = 0.1543
\end{equation*}
...
- $\rho_{01} = 0.145 =$ the correlation in programs’ random intercept and their random rates of change.
