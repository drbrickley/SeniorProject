...
stargazer(preview, type = 'latex', summary = FALSE, title= "Selected variables from the first five observations in the dataset.")
```
...
stargazer(summarydata, type = "latex", title = "Summary Statistics", summary.stat = c("mean","sd", "min", "p25", "median", "p75", "max"), digits = 1, digits.extra = 0)
